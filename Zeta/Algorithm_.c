...
static void Zeta_Insertion_(Zeta_Vector* vec, size_t width, size_t i,
                            void* cmper_context,
...
static void Zeta_InsertionSort_(Zeta_Vector* vec, size_t width, size_t beg,
...
/*
static void Zeta_ShellSort_(Zeta_Vector* vec, size_t width, size_t beg,
                            size_t end, void* cmper_context,
                            int (*cmper)(void* cmper_context, const void* x,
                                         const void* y)) {
    size_t gaps[] = {
...
static size_t Zeta_Partition_(Zeta_Vector* vec, size_t width, size_t beg,
                              size_t end, void* cmper_context,
                              int (*cmper)(void* cmper_context, const void* x,
                                           const void* y)) {
    void* vec_context = vec->context;
...
static size_t Zeta_SimplePartition_(
    Zeta_Vector* vec, size_t width, size_t beg, size_t end, void* cmper_context,
...
static void Zeta_KthElement_(Zeta_Vector* vec, size_t width, size_t beg,
                             size_t mid, size_t end, void* cmper_context,
                             int (*cmper)(void* cmper_context, const void* x,
                                          const void* y));
...
void Zeta_KthElement(Zeta_Vector* vec, size_t width, size_t beg, size_t mid,
                     size_t end, void* cmper_context,
                     int (*cmper)(void* cmper_context, const void* x,
                                  const void* y)) {
    ...
    size_t size = vec->GetSize(vec->context);
...
void Zeta_Sort_(size_t chance, Zeta_Vector* vec, size_t width, size_t beg,
                size_t end, void* cmper_context,
                int (*cmper)(void* cmper_context, const void* x,
                             const void* y)) {
    for (;;) {
