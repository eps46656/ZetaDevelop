...
void Zeta_Logger_LogBool_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteStr(
        pipe, (unsigned char const*)(*((bool_t*)ptr) ? "True " : "False"),
        ZETA_io_l_just, 0, ' ');
}

void Zeta_Logger_LogChar_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteSInt(pipe, *((char*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogUChar_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteUInt(pipe, *((unsigned char*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogSChar_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteSInt(pipe, *((signed char*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogUInt_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteUInt(pipe, *((unsigned*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogSInt_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteSInt(pipe, *((int*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogULong_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteUInt(pipe, *((unsigned long*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogSLong_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteSInt(pipe, *((long*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogULLong_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteUInt(pipe, *((unsigned long long*)ptr), FALSE, 10,
                        ZETA_io_r_just, ZETA_LogVar_varval_just_width, ' ');
}

void Zeta_Logger_LogSLLong_(Zeta_Pipe* pipe, void* ptr) {
    Zeta_Pipe_WriteSInt(pipe, *((long long*)ptr), FALSE, 10, ZETA_io_r_just,
                        ZETA_LogVar_varval_just_width, ' ');
}
...
void Zeta_Logger_LogPtr_(Zeta_Pipe* pipe, void* ptr) {
    ...
    Zeta_Pipe_WriteUInt(pipe, ZETA_PtrToAddr(*((void**)ptr)), FALSE, 16,
