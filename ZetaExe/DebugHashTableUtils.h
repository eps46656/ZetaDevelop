...
void DebugHashTable_Init(
    ...
    Zeta_DebugHashTable_DeployAssocContainer(&pack->debug_ht, assoc_cntr);
}

void DebugHashTable_Deinit(Zeta_AssocContainer* assoc_cntr) {
    if (assoc_cntr == NULL ||
...
template <typename Val>
Zeta_AssocContainer* DebugHashTable_Create(
...
void DebugHashTable_Destroy(Zeta_AssocContainer* assoc_cntr) {
    if (assoc_cntr == NULL ||
        assoc_cntr->GetSize != Zeta_DebugHashTable_GetSize) {
        return;
    }
...
void DebugHashTable_Sanitize(Zeta_AssocContainer const* assoc_cntr) {
